...
let profilePicInput = document.getElementById(
  "profile-image"
) as HTMLInputElement;
let degreeInput = document.getElementById("degree") as HTMLInputElement;
let institutionInput = document.getElementById(
  "institution"
) as HTMLInputElement;
...
let previewProfilePic = document.getElementById(
  "previewProfilePic"
) as HTMLImageElement;
let previewEducation = document.getElementById(
  "previewEducation"
) as HTMLElement;
...
function updateResume() {
  ...
  previewEducation.textContent = `${
    degreeInput.value || "Bachelor's Degree"
  } in ${institutionInput.value || "University"} (${
    gradYearInput.value || "2020"
  })`;
  previewWork.textContent = `${jobTitleInput.value || "Software Engineer"} at ${
